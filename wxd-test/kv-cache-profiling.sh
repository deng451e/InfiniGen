...
do 
    ...
    do 
        ...
        do
                ...
                CMD="--model huggingface/${arch_name} --percent 100 0 0 100 100 0 --overlap false --gpu-batch-size 1 --num-gpu-batches 1 --prompt-len ${prompt_len} --gen-len ${gen_len} --warmup-input-path pg19_firstbook.txt --test-input-path $HOME/input/wikitext.txt/wikitext-2-v1/test-00000-of-00001.txt"
