...
class TorchDevice:
    ...
    def mha(self, inputs, attention_mask, w_q, b_q, w_k, b_k, w_v, b_v,
        ...
        return TorchTensor.create_from_torch(value, self), k, v,attn_weights.detach()
    ...
    def mha_gen(self, inputs, attention_mask, w_q, b_q, w_k, b_k, w_v, b_v,
        ...
        if isinstance(k_cache, TorchTensor):
            if attn_sparsity >= 1.0:  # Dense attention
                ...
                if k.is_cuda:
                    value,attn_weights = self._sparse_attention_value(q, k, v_new, v_cache,
        ...
        return TorchTensor.create_from_torch(value, self), k_new, v_new,attn_weights
    ...
    def _attention_value(self, q, k, v, mask, b, src_s, tgt_s, n_head, head_dim):
        ...
        # shape: (b, n_head, 1, head_dim)
        return torch.bmm(attn_weights, v).view(b, n_head, tgt_s, head_dim),attn_weights.detach()
